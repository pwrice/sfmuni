...
get the app created:
    ...
    $ heroku apps:create sfmuni
    Creating sfmuni... done, stack is cedar
    http://sfmuni.herokuapp.com/ | git@heroku.com:sfmuni.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://sfmuni.herokuapp.com deployed to Heroku

    To git@heroku.com:sfmuni.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://sfmuni.herokuap.com
    ["Hello" :from Heroku]
